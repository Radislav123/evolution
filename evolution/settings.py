...
GENE_INTERFACE_JSON_PATH = f"{CHROMOSOME_JSON_PATH}/gene_interface"
GENE_JSON_PATH = f"{CHROMOSOME_JSON_PATH}/gene"
BODYPART_INTERFACE_JSON_PATH = f"{CREATURE_JSON_PATH}/bodypart_interface"
BODYPART_JSON_PATH = f"{CREATURE_JSON_PATH}/bodypart"
